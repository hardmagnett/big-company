...
<template>
  <div class="view-about">
    ...
    <p>
      ...
      Поэтому правильная работа гарантируется лишь в Chrome и Edge на десктопе и на
      смартфонах.
      <br />
    </p>
    <p>Что из нового:</p>
    ...
    <p>В Git-е можно посмотреть кто и когда сделал любой коммит или изменил любую строку в любом файле.</p>
