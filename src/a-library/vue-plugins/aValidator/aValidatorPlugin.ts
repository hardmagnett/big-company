...
export default {
  // todo::при анмаунте инпута наверное делать очистку данных инпута?
  //  Чтобы не было такого что инпута с таким именем в документе нет, но при этом происходит конфликт по именам?
  install: (
    app: App,
