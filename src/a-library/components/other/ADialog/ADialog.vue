...
let runClosingOnDeniedAnimation = () => {
  let animationTime = getValueOfCSSVariableAsNumber(
    "--closing-denied-animation-duration",
    dialogNode.value,
  );
  ...
  <dialog
    ...
    :class="{
      'a-dialog--animation-closing-is-denied':
        isClosingOnDeniedAnimationRunning,
    }"
    @cancel="cancelDialogHandler"
  >
    <div ref="dialogWrapperNode" class="a-dialog__wrapper">
      <div v-if="textHeader" class="a-dialog__header">
